    ...
    <br>
        ...
        <tbody>
            <tr>
                ...
                <td id="check"><p>2)  A dealing with a genetically modified Caenorhabditis elegans, unless:<br>
...
(b) as a result of the genetic modification, the animal is capable of secreting or producing an infectious agent.</p></td>
            ...
            <tr>
                ...
                <td id="check"><p>3)   A dealing with an animal into which genetically modified somatic cells have been introduced, if:<br>
...
(b) the animal is not infected with a virus that is capable of recombining with the genetically modified nucleic acid in the somatic cells.</p></td>
            ...
            <tr>
                ...
                <td id="check"><p>3A) A dealing with an animal whose somatic cells have been genetically modified in vivo by a   replication defective viral vector, if:<br>
(a) the in vivo modification occurred as part of a previous dealing; and<br>
        ...
        (e) the animal is not infected with a virus that can recombine with the genetically              modified nucleic acid in the somatic cells of the animal.</p></td>
            ...
            <tr>
                ...
                <td id="check"><p>(1) Subject to subitem (2), a dealing involving a host/vector system mentioned in Part 2 of  this Schedule and producing no more than 25 litres of GMO culture in each vessel containing the resultant culture.<br>
...
(A) is not available in the cell into which the nucleic acid is introduced; and<br>(B) will not become available during the dealing; and<br>
            ...
            <tr>
                ...
                <td id="check"><p>5) A dealing involving shot gun cloning, or the preparation of a cDNA library, in a host/vector system mentioned in item 1 of Part 2 of this Schedule, if the donor nucleic acid is not derived from either: <br>
(a) a pathogen; or<br>
