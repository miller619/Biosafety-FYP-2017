...
<div id="wrapper" class="active">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
                <h2>Application for Notifiable Low Risk Dealings (NLRDs) suitable for Physical Containment level 1 (PC1)</h2>
                            ...
                            <table id="bio" class="table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><p>a) A dealing involving a genetically modified laboratory guinea pig, a genetically modified laboratory mouse, a genetically modified laboratory rabbit or a genetically modified laboratory rat, unless:<br><br></p>
                                        <p> class="col-xs-12">(i) an advantage is conferred on the animal by the genetic modification; or<br>
                                        (ii) the animal is capable of secreting or producing an infectious agent as a result of the genetic modification;</p></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>(c) A dealing involving a replication defective vector derived from Human adenovirus or Adeno associated virus in a host mentioned in item 4 of Part 2 of Schedule 2, if the donor nucleic acid:<br><br>
                                            ...
                                            (B) encode a protein with immunomodulatory activity in humans.</p></td>
                                        </tr>
