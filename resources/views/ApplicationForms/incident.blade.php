...
<div class="well">
            ...
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('gender', '1.02 Gender:', ['class' => 'control-label']) !!} <br>
                    	...
                    	<input type="checkbox" value="Yes" id="checkboxgroup">Male
                    	<input type="checkbox" value="Yes" id="checkboxgroup">Female
            ...
            <div class="col-xs-12">
            	<div class="form-group">
                    ...
                    <p id="checkboxgroup">
                    	...
                    	<input type="checkbox" value="unsafeworkplace" id="Female">Unsafe Workplace Condition
                    </p>    
                    <br><br>
                    	<p>Others (Specify):</p>
    ...
    <fieldset>
    	<legend>SECTION 4 – For Investigation Team Only (*Details required as per OSH (NADOPOD) Regulation 2004)
</legend>
