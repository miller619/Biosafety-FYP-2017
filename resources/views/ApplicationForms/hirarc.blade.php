...
<div id="wrapper" class="active">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
                <div class="container">
                    <h3>Occupational Safety & Health Management System</h3>
                    <h2>Hazard Identification, Risk Assessment, Risk Control (HIRARC) Form</h2>
                    <br>
                    <h5>PLEASE FILL OUT ALL INFORMATION REQUESTED</h5>
