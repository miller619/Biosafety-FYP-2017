...
<div class="well">
    ...
    <div class="row">
        ...
        <tbody>
            <tr>
                <td colspan="2">SBC REFERENCE NUMBER <input id="row-1-no" name="row-1-no" type="text" ></td>
            </tr>
            <br>
            <tr>
            	<td>DATE OF PROJECT APPROVAL<input id="row-1-no" name="row-1-no" type="text" ></td>
            	<td>DATE OF THIS REPORT<input id="row-1-no" name="row-1-no" type="text" ></td>
            </tr>
            <tr>	
            	<td colspan="2">ANNUAL/FINAL REPORT (Delete as applicable)<input id="row-1-no" name="row-1-no" type="text" ></td>
            </tr>
        </tbody>
        </table>
    </div>
